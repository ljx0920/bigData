#!/bin/sh
#
# start dataQuery-restful
#
###EOF

prog=dataQuery-restful
...
${JAVA_HOME}/bin/java -cp ${DEPLOY_PATH}/resources:${DEPLOY_PATH}/lib/*:${DEPLOY_PATH}/lib/dataQuery-Restful-1.0.jar:. ${JAVA_OPTIONS} ${JAVA_DEBUG} com.dq.manage.dataQueryRestApplication $prog &
